...
$MESS["OASIS_IMPORT_OPTIONS_TAB_CRON_DESC_CUSTOM"] = "<strong>Добавьте данное задание в CRON</strong><br/>Импорт/обновление товаров: <br/><code>* * * * * /usr/bin/php -f %s</code><br/>Обновление остатков: <br/><code>* * * * * /usr/bin/php -f %s --up</code>";
